...
public class StatusBarUtil {
     ...
     * @param activity       需要设置的activity
     * @param statusBarAlpha 状态栏透明度
     * @param needOffsetView 需要向下偏移的 View(比如标题栏)
     */
    ...
    /**
     *
     * 为 fragment 头部是 ImageView 的设置状态半栏透明
     *
    ...
    /**
     * //TODO 待解决
     * 为 fragment 自定义标题栏 设置状态栏透明
     * @param activity
     */
    public static void setTranslucentForCustomTitleInFragment(Activity activity,View needOffsetView){
